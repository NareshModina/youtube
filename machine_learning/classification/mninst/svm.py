...
# model = LinearSVC(random_state=42, max_iter=1000) #uncomment this line to try LinearSVC

# Create and train the nonlinear SVM model
model = SVC(
    kernel='rbf',  # Nonlinear kernel (could also use 'poly' or 'sigmoid')
    random_state=42,
